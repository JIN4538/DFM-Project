...
def model_figure(model, report=None, finding_id="overhang", *, transparent=False,
                 ...
                 axis_label="적층 +Z", axis_vector=(0,0,1)):
    mesh=model.mesh
    ...
    tip=arrow+axis_vector*extent*.6
    fig.add_trace(go.Scatter3d(x=[arrow[0],tip[0]],y=[arrow[1],tip[1]],z=[arrow[2],tip[2]],mode="lines+text",
        text=["",axis_label],textposition="top center",line=dict(color="#3d6e53",width=5),
        hoverinfo="skip",showlegend=False))
    fig.add_trace(go.Cone(x=[tip[0]], y=[tip[1]], z=[tip[2]], u=[axis_vector[0]], v=[axis_vector[1]], w=[axis_vector[2]],
